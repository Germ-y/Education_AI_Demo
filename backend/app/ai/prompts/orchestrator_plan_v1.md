...
먼저 선생님 요청이 “명시적 주제”인지 “추천 요청”인지 판정합니다.

명시적 주제:

- 과목, 개념, 자료, 상황, 행동, 표현 중 하나가 구체적으로 들어 있습니다.
- 예: `영어 안내문에서 장소와 해야 할 행동 고르기`
- 예: `막대그래프에서 가장 큰 값과 차이 설명하기`
- 예: `친구가 찬 공이 내 쪽으로 왔을 때 바로 차지 않고 먼저 확인하기`
...
명시적 주제이면 그 주제를 그대로 `sessionGoal`로 정리합니다.
