...
- 학생이 읽어야 하는 정확한 문제 문장, 선택지, 정답 단서는 이미지에 넣지 않습니다.
...
- 날짜, 숫자, 문장 같은 문제 풀이 단서를 이미지에 넣어 문제를 풀게 합니다.
...
- 4단계가 모두 있습니다.
- 2~3단계 템플릿은 입력의 사고 유형 기반 지정값을 그대로 따릅니다.
...
- 이미지는 장소, 사람 관계, 조작물, 활동 흐름을 충분히 보여줍니다.
- 글 자료를 읽어야 풀리는 장면으로 설계하지 않습니다. 필요한 정확한 조건은 다음 콘텐츠 생성 단계의 짧은 문제 UI에 둡니다.
