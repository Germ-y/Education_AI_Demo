    ...
    return DemoDatabase.model_validate(
        {
                ...
                },
                {
                    ...
                    "profileJson": {
                        ...
                        "dashboard": {
                            ...
                            "primaryNeedDetail": "포스터나 안내문처럼 생활 속 짧은 글에서 확인 가능한 단서와 생각이 담긴 표현을 구분하는 수업이 좋겠어요.",
                            "supportStrategyTitle": "시각 자료 + 기준 카드 + 근거 말하기",
                            "supportStrategyDetail": "먼저 장면을 보고, 기준 카드를 확인한 뒤, 판단 근거를 한 문장으로 말해보는 콘텐츠가 좋겠어요.",
                            "strengths": [
                            ...
                            "schoolContextNote": "NEIS 시간표의 국어·사회·과학 등 읽기 자료가 많은 날에는 생활 장면형 문장 판단 콘텐츠와 연결합니다.",
                            "nextSessionFocus": ["확인 가능한 단서 찾기", "사실·의견 구분하기", "판단 근거 한 문장으로 말하기"],
                            "aiContextSummary": "중2 고연령 학습지원형 학생. 짧은 정보 문장을 보고 확인 가능한 단서와 생각이 담긴 표현을 구분하는 수업이 잘 맞아 보여요. 장면 자료와 기준 카드로 부담을 낮추고, 마지막에는 판단 근거를 한 문장으로 말하는 콘텐츠가 좋겠어요.",
                        },
                    },
                },
                {
            ...
            "supportCases": [
                ...
                },
                {
                    ...
                    "supportStrategy": "생활 장면 자료와 기준 카드로 첫 판단을 쉽게 만든 뒤 한 문장 근거 말하기로 연결",
                    "openedAt": NOW,
                },
                {
                    "id": "case_life_bus",
