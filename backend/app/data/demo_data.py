    ...
    return DemoDatabase.model_validate(
        {
            ...
            "students": [
                {
                    ...
                    "profileJson": {
                        ...
                        "dashboard": {
                            ...
                            "summaryLine": "짧은 시각 단서와 2개 선택지로 시간 읽기 기초를 익히는 수업이 필요한 초3 학생입니다.",
                            "primaryNeedTitle": "시간 읽기 기초 보완 수업",
                            "primaryNeedDetail": "긴 설명보다 짧은 시각 단서로 시침과 분침을 구분하고 읽는 순서를 익히는 수업이 필요합니다.",
                            "supportStrategyTitle": "시각 단서 기반 2지선다 수업",
                            "supportStrategyDetail": "한 문장 지시, 큰 그림 단서, 2개 선택지를 사용해 시간 읽기 순서를 안정화하는 콘텐츠가 적합합니다.",
                            ...
                            "aiContextSummary": "초3 저연령 학습지원형 학생. 시간 읽기 기초 보완 수업이 필요하며, 긴 문장 설명보다 짧은 시각 단서와 2개 선택지를 중심으로 한 성공 경험형 콘텐츠가 좋습니다.",
                        },
                    },
                },
                {
                    ...
                    "profileJson": {
                        ...
                        "dashboard": {
                            ...
                            "statusLabel": "자료 검토",
                            "attendanceLabel": "95%",
                            "summaryLine": "분수의 전체-부분 관계를 절차적으로 익히는 개념 보완 수업이 필요한 중2 학생입니다.",
                            "primaryNeedTitle": "분수 개념 보완 수업",
                            "primaryNeedDetail": "전체와 부분을 구분하고 분모·분자의 의미를 순서대로 연결하는 수업이 필요합니다.",
                            "supportStrategyTitle": "시각 자료 + 단계 카드 + 말로 정리하기",
                            "supportStrategyDetail": "시각 자료, 단계 카드, 빈칸 확인, 말로 정리하기를 사용해 전체-부분 관계를 반복 연결하는 콘텐츠가 적합합니다.",
                            ...
                            "nextSessionFocus": ["전체와 부분 구분하기", "분모·분자 의미 연결하기", "말로 짧게 정리하기"],
                            "aiContextSummary": "중2 고연령 학습지원형 학생. 분수의 전체-부분 관계를 단계적으로 익히는 개념 보완 수업이 필요하며, 시각 자료와 짧은 단계 카드로 절차를 나눈 콘텐츠가 좋습니다.",
                        },
                    },
                },
                {
                    ...
                    "profileJson": {
                        ...
                        "dashboard": {
                            ...
                            "statusLabel": "학습",
                            "attendanceLabel": "91%",
                            "summaryLine": "생활 상황에서 순서를 확인하고 도움 요청 표현을 말하는 의사소통 수업이 필요한 초6 학생입니다.",
                            "primaryNeedTitle": "일상생활 의사소통 수업",
                            "primaryNeedDetail": "낯선 생활 상황에서 단서를 확인하고 필요한 도움 요청 문장을 짧게 말하는 수업이 필요합니다.",
                            "supportStrategyTitle": "상황 그림 + 순서 카드 + 역할 발화",
                            "supportStrategyDetail": "상황 그림, 순서 카드, 짧은 모델 문장, 실시간 역할 발화 연습을 조합한 콘텐츠가 적합합니다.",
                            ...
                            "aiContextSummary": "초6 일상생활 지원형 학생. 생활 상황에서 순서를 확인하고 도움 요청 표현을 말하는 의사소통 수업이 필요하며, 상황 그림과 순서 카드 뒤 실시간 역할 발화 연습으로 이어지는 콘텐츠가 좋습니다.",
                        },
                    },
                },
            ],
            ...
            "supportCases": [
                ...
                },
                {
                    ...
                    "ownerTeacherId": "user_teacher_demo",
                    "caseStatus": "open",
                    "currentGoal": "생활 상황에서 순서 확인과 도움 요청 표현 연습",
            ...
            "plannerItems": [
                ...
                },
                {
                    ...
                    "caseId": "case_learning_fraction",
                    "periodType": "next_session",
                    "goalText": "분수의 전체-부분 관계를 단계 카드로 설명하기",
