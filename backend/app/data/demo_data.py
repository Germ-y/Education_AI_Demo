    ...
    return DemoDatabase.model_validate(
        {
                ...
                },
                {
                    ...
                    "profileJson": {
                        ...
                        "dashboard": {
                            ...
                            "statusLabel": "자료 검토",
                            "attendanceLabel": "95%",
                            "summaryLine": "분수의 전체-부분 관계를 절차적으로 익히는 개념 보완 수업이 잘 맞아 보여요.",
                            "primaryNeedTitle": "분수 개념 보완 수업",
                            "primaryNeedDetail": "전체와 부분을 구분하고 분모·분자의 의미를 순서대로 연결하는 수업이 좋겠어요.",
                            "supportStrategyTitle": "시각 자료 + 단계 카드 + 말로 정리하기",
                            "supportStrategyDetail": "시각 자료, 단계 카드, 빈칸 확인, 말로 정리하기를 사용해 전체-부분 관계를 반복 연결하는 콘텐츠가 좋겠어요.",
                            "strengths": [
                                "그림이나 조각 모델을 보면 전체와 부분을 더 쉽게 이해해요.",
                                "과정을 작은 단계로 나누면 끝까지 따라올 수 있어요.",
                                "요리나 탐험처럼 구체적인 소재가 있으면 참여가 좋아져요.",
                            ],
                            "weaknesses": [
                                "분모와 분자가 각각 무엇을 뜻하는지 자주 바꿔 생각해요.",
                                "문제 설명이 길면 중요한 조건을 놓칠 수 있어요.",
                                "응용 문제에서는 전체를 먼저 확인하는 순서가 흔들려요.",
                            ],
                            ...
                            "aiContextSummary": "중2 고연령 학습지원형 학생. 분수의 전체-부분 관계를 단계적으로 익히는 개념 보완 수업이 잘 맞아 보여요. 시각 자료와 짧은 단계 카드로 절차를 나눈 콘텐츠가 좋겠어요.",
                        },
                    },
                },
                {
            ...
            "plannerItems": [
                ...
                },
                {
                    ...
                    "caseId": "case_learning_fraction",
                    "periodType": "next_session",
                    "goalText": "분수의 전체-부분 관계를 단계 카드로 설명해보면 좋겠어요.",
