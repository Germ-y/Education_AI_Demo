    ...
    return DemoDatabase.model_validate(
        {
            ...
            "students": [
                {
                    ...
                    "primaryNeed": "시계 그림에서 짧은 바늘을 먼저 찾고 약속 시간을 고르는 연습",
                    "profileJson": {
                        "ageBand": "younger",
                        "gradeNumber": "3",
                        "className": "1",
                        ...
                        "dashboard": {
                            ...
                            "summaryLine": "그림 단서와 짧은 선택지에 잘 반응하는 초3 학습지원형 학생입니다.",
                            "primaryNeedTitle": "시계 그림에서 시간 단서 찾기",
                            "primaryNeedDetail": "긴 설명을 읽기 전에 시계 그림에서 짧은 바늘을 먼저 찾도록 돕는 것이 필요합니다.",
                            "supportStrategyTitle": "그림 먼저 보기 + 2개 선택지",
                            "supportStrategyDetail": "시계 그림을 먼저 보여주고 짧은 바늘을 찾은 뒤, 2개 선택지 중 약속 시간을 고르게 합니다.",
                            "strengths": ["그림 단서를 빠르게 찾음", "짧은 선택지에 안정적으로 반응", "마스코트 안내에 주의가 잘 모임"],
                            "weaknesses": ["긴 문장 지시에서 첫 행동 시작 부담", "시계 읽기 순서가 흔들림", "실패 경험 뒤 다시 시도까지 시간이 걸림"],
                            ...
                            "nextSessionFocus": ["짧은 바늘 먼저 찾기", "2개 선택지에서 약속 시간 고르기", "첫 문항은 쉬운 성공 경험으로 시작"],
                            "aiContextSummary": "초3 저연령 학습지원형 학생. 그림 단서와 2개 선택지에 반응이 좋고 긴 문장 지시는 부담이 있어, 시계 그림을 먼저 보고 짧은 바늘을 찾는 쉬운 성공 경험으로 시작합니다.",
                        },
                    },
                },
                {
                    ...
                    "profileJson": {
                        ...
                        "dashboard": {
                            ...
                            "statusLabel": "자료 검토",
                            "attendanceLabel": "95%",
                            "summaryLine": "분수 개념은 이해하려 하지만 문제 상황에서 분모/분자 위치가 흔들리는 중2 학생입니다.",
                            "primaryNeedTitle": "분수의 전체-부분 관계 안정화",
                            "primaryNeedDetail": "전체 수와 고른 수를 구분한 뒤 분모/분자 위치로 연결하는 순서가 반복적으로 필요합니다.",
                            "supportStrategyTitle": "시각 자료 + 단계 따라하기 + 설명해보기",
                            "supportStrategyDetail": "전체를 먼저 세고 고른 것을 나중에 세는 절차를 이미지, 빈칸, 말로 다시 설명하는 활동으로 반복합니다.",
                            "strengths": ["그림 자료 반응", "짧은 단계 설명", "탐험/요리 소재에 관심"],
                            "weaknesses": ["분모/분자 위치 혼동", "문장 조건 읽기 부담", "응용 문제에서 순서가 흔들림"],
                            ...
                            "schoolContextNote": "NEIS 시간표에서 최근 수학 수업 흐름을 확인해 분수 복습 콘텐츠와 연결합니다.",
                            "nextSessionFocus": ["전체 수 먼저 세기", "고른 수를 분자로 연결", "1/4 설명 성공 뒤 2/4로 확장"],
                            "aiContextSummary": "중2 고연령 학습지원형 학생. 그림 자료와 짧은 단계 설명에 반응하며, 분수의 전체-부분 관계에서 분모/분자 위치 혼동이 반복되어 절차형 문제와 말로 다시 설명해보는 활동이 필요합니다.",
                        },
                    },
                },
                {
                    ...
                    "profileJson": {
                        ...
                        "dashboard": {
                            ...
                            "statusLabel": "학습",
                            "attendanceLabel": "91%",
                            "summaryLine": "상황 그림과 순서 카드에는 잘 반응하지만 실제 도움 요청 말하기에서 멈춤이 있는 학생입니다.",
                            "primaryNeedTitle": "센터 이동 순서와 도움 요청 연습",
                            "primaryNeedDetail": "버스 정류장, 목적지, 도움 요청 문장을 상황 순서에 맞게 연결하는 연습이 필요합니다.",
                            "supportStrategyTitle": "상황 이미지 + 순서 카드 + 역할 연습",
                            "supportStrategyDetail": "실제 이동 장면을 이미지로 먼저 보고, 순서 카드를 맞춘 뒤 짧은 도움 요청 문장을 실시간 역할 발화 연습으로 이어가면 좋습니다.",
                            "strengths": ["상황 그림 이해", "역할 연습 참여", "동네 지도 소재에 관심"],
                            "weaknesses": ["이동 순서 계획", "도움 요청 말하기", "낯선 상황에서 다음 행동 확인"],
                            ...
                            "nextSessionFocus": ["목적지 말하기", "도움 요청 문장 1개 말하기", "다음 행동 확인하기"],
                            "aiContextSummary": "초6 일상생활 지원형 학생. 상황 그림과 순서 카드에는 잘 반응하지만 실제 도움 요청 말하기에서 멈춤이 있어, 센터 이동 시나리오와 실시간 역할 발화 연습을 함께 구성하면 좋습니다.",
                        },
                    },
                },
            ],
            ...
            "supportCases": [
                ...
                },
                {
                    ...
                    "supportStrategy": "그림 자료와 짧은 단계 설명으로 분모/분자 위치를 반복 확인",
                    "openedAt": NOW,
                },
                {
                    "id": "case_life_bus",
            ...
            "plannerItems": [
                {
                    ...
                    "goalText": "\uc2dc\uacc4 \uadf8\ub9bc\uc5d0\uc11c \uc9e7\uc740 \ubc14\ub298\uc744 \uba3c\uc800 \ucc3e\uace0 \uc57d\uc18d \uc2dc\uac04 \uace0\ub974\uae30",
                    "checklistJson": {
            ...
            "realtimeSessions": [
                {
                    ...
                    "model": "gpt-realtime",
                    "status": "completed",
                    "specSnapshotJson": {"stageId": "stage_fraction_4", "templateType": "realtime_teach_back", "maxTurns": 6},
                    ...
                    "rubricResultJson": {
                        "mention_whole": True,
                        "mention_part": True,
                        "connect_fraction": True,
                        "supportNeeded": "분모를 떠올리는 짧은 단서 1회",
                    },
                    "transcriptSummary": "시각 자료를 보며 전체 4조각 중 고른 조각 1개를 1/4로 설명했고, 분모 단서가 한 번 필요했습니다.",
                },
                {
                    ...
                    "model": "gpt-realtime",
                    "status": "completed",
                    "specSnapshotJson": {"stageId": "stage_bus_4", "templateType": "realtime_roleplay", "maxTurns": 6},
            ...
            "reviewSummaries": [
                {
                    ...
                    "accuracyRate": 0.5,
                    "shortSummary": (
                        "4단계를 모두 완료했습니다. 그림 자료에는 안정적으로 반응했고, 전체 조각 수를 먼저 세도록 짧게 안내하자 1/4 설명이 가능했습니다."
                    ),
                    "wrongPatternJson": {
                        "answerCount": 2,
                        "correctCount": 1,
                        "wrongCount": 1,
                        "patterns": ["전체 조각 수보다 고른 조각 수를 먼저 세며 분모/분자 위치를 헷갈림"],
                    },
                    "realtimeResultJson": {
                        "sessionId": "rt_session_fraction_20260502",
                        "rubricPassed": ["mention_whole", "mention_part", "connect_fraction"],
                        "nextSupport": "다음 회기 시작 시 전체 조각 수를 먼저 세고, 그다음 고른 조각 수를 세는 순서를 반복합니다.",
                    },
                },
                {
