    ...
    contracts: dict[str, dict[str, Any]] = {
        ...
        "sequence_ordering": {
            ...
            "hardRules": [
                ...
                (
                    "answerOrder must follow the semantic order requested by question, not the display order of cards; "
                    "for example, 더 단단한 것부터 means the hardest card id comes first."
                ),
