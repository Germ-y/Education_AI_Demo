...
class Settings(BaseSettings):
    ...
    openai_orchestrator_model: str = "gpt-5-nano"
    openai_content_model: str = "gpt-5-mini"
    openai_critique_model: str = "gpt-5-nano"
    openai_image_brief_model: str = "gpt-5-nano"
    openai_response_timeout_sec: float = 90
    openai_orchestrator_timeout_sec: float = 60
    openai_content_timeout_sec: float = 120
    openai_critique_timeout_sec: float = 45
