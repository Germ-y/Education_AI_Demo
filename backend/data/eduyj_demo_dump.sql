...
INSERT INTO support_cases VALUES('case_learning_clock','student_learning_clock','user_teacher_demo','open','시간 읽기 기초를 짧은 시각 단서와 2개 선택지로 익혀보면 좋겠어요.','2026-05-02T00:00:00.000Z','material_generation','그림 먼저 보기와 2개 선택지로 첫 성공 경험을 만든 뒤 짧은 음성 안내를 연결');
INSERT INTO support_cases VALUES('case_learning_fraction','student_learning_fraction','user_teacher_demo','open','분수의 전체-부분 관계를 단계 카드로 안정화해보면 좋겠어요.','2026-05-02T00:00:00.000Z','material_review','그림 자료와 짧은 단계 설명으로 분모/분자 위치를 반복 확인');
INSERT INTO support_cases VALUES('case_life_bus','student_life_bus','user_teacher_demo','open','생활 상황에서 순서 확인과 도움 요청 표현을 연습해보면 좋겠어요.','2026-05-02T00:00:00.000Z','learning','상황 그림과 역할 연습으로 도움 요청 문장을 짧게 반복');
...
INSERT INTO activity_events VALUES('event_bus_s3_correct','attempt_bus_20260502','student_life_bus','stage_bus_3','answer_submitted','{"answer": {"order": ["check_bus", "take_bus", "arrive_center"]}, "isCorrect": true, "hintUsed": true}','2026-05-02T10:12:50.000Z');
