...
| 오케스트레이터/메모리 | [../backend/01-orchestrator-memory.md](../backend/01-orchestrator-memory.md) | [../backend/02-ai-backend-system-design.md](../backend/02-ai-backend-system-design.md), [../backend/03-backend-feature-spec.md](../backend/03-backend-feature-spec.md), [../backend/08-ai-orchestrator-workflow.md](../backend/08-ai-orchestrator-workflow.md) |
