...
export const coachingScenes: CoachingScene[] = [
  {
    ...
    stageQuestions: [
      {
        step: 1,
        stageId: "stage-emotion-1",
        stageRole: "scenario_intro",
        templateType: "scene_observation",
        assetRole: "stage_1",
        kind: "concept",
        prompt: "표정 카드를 천천히 살펴봐요",
        body: "오늘 마음과 가장 가까운 표정을 찾기 전에, 각 카드가 어떤 느낌을 담고 있는지 봐요.",
        hint: "표정, 색, 몸의 느낌을 함께 보면 마음 이름을 고르기 쉬워요.",
        correctFeedback: "좋아요. 마음 카드를 살펴봤어요.",
        wrongFeedback: "괜찮아요. 표정을 한 번 더 천천히 봐요.",
        completionTitle: "마음 카드 보기 완료",
        completionMessage: "네 가지 마음 카드를 살펴봤어요.",
        actionLabel: "카드 살펴봤어요",
        conceptCards: [
          { title: "신나요", body: "몸이 가볍고 웃음이 나오는 마음이에요." },
          { title: "편안해요", body: "숨이 천천히 쉬어지고 괜찮다고 느끼는 마음이에요." },
          { title: "걱정돼요", body: "앞일이 자꾸 떠올라 몸이 긴장되는 마음이에요." },
        ],
        visualActiveIndex: 1,
      },
      {
        step: 2,
        stageId: "stage-emotion-2",
        ...
        correctAnswer: "편안해요",
        hint: "초록색 카드처럼 숨이 천천히 쉬어지는 마음을 찾아보세요.",
        correctFeedback: "좋아요. 편안한 마음을 잘 찾았어요.",
        wrongFeedback: "표정이 가장 차분한 카드를 다시 찾아볼까요?",
        completionTitle: "마음 이름 찾기 완료",
        completionMessage: "오늘 마음과 가까운 이름을 골랐어요.",
        visualActiveIndex: 1,
      },
      {
        step: 3,
        stageId: "stage-emotion-3",
        stageRole: "action_selection",
        templateType: "decision_card",
        assetRole: "stage_3",
        kind: "scenario",
        prompt: "편안한 마음을 지키려면 어떤 도움이 좋을까요?",
        choices: ["천천히 숨 쉬기", "큰 소리로 말하기", "바로 포기하기"],
        correctAnswer: "천천히 숨 쉬기",
        hint: "마음을 더 차분하게 만드는 작은 행동을 골라요.",
        correctFeedback: "좋아요. 천천히 숨 쉬기는 편안한 마음을 지키는 데 도움이 돼요.",
        wrongFeedback: "몸과 마음이 더 편안해지는 행동을 다시 골라볼까요?",
        completionTitle: "도움 카드 선택 완료",
        completionMessage: "편안한 마음을 지키는 행동을 골랐어요.",
        scenarioLines: [
          { speaker: "별", text: "편안한 마음을 계속 지키고 싶어." },
          { speaker: "학생", text: "작게 할 수 있는 도움 행동을 골라볼게." },
        ],
        visualActiveIndex: 1,
      },
      {
        step: 4,
        stageId: "stage-emotion-4",
        stageRole: "realtime_practice",
        templateType: "realtime_roleplay",
        assetRole: "stage_4_realtime",
        kind: "realtimeTeachBack",
        prompt: "오늘 마음을 생활에서 말해보는 연습을 해요",
        body: "비슷한 상황이 오면 쓸 수 있는 말을 연습해요.",
        hint: "내 마음과 작은 도움 행동을 한 문장으로 말해보세요.",
        correctFeedback: "좋아요. 생활에서 바로 쓸 수 있는 말로 연습했어요.",
        wrongFeedback: "조금 더 짧고 편한 말로 바꿔볼까요?",
        completionTitle: "마음 말하기 연습 완료",
        completionMessage: "오늘 마음을 생활에서 말할 준비가 됐어요.",
        actionLabel: "마음 말하기 연습 시작하기",
        realtimePracticeSpec: {
          role: "student_applies_emotion_support",
          firstPrompt: "오늘 마음이 어떤지, 그리고 편안해지려면 무엇을 해볼지 말해볼래요?",
          rubric: ["마음 이름을 말한다", "작은 도움 행동을 말한다", "생활에서 쓸 문장으로 말한다"],
  ...
  },
  {
    ...
    stageQuestions: [
      {
        step: 1,
        stageId: "stage-older-1",
        stageRole: "scenario_intro",
        templateType: "concept_intro",
        assetRole: "stage_1",
        kind: "concept",
        prompt: "과제를 한 번에 보지 말고 작은 칸으로 나눠요",
        body: "긴 과제는 한 번에 끝내려고 하면 시작이 어려워져요. 먼저 전체를 보고 작은 행동으로 나누는 연습을 해요.",
        hint: "지금은 정답을 찾기보다 과제를 작게 보는 단계예요.",
        correctFeedback: "좋아요. 과제를 작은 칸으로 나눠볼 준비가 됐어요.",
        wrongFeedback: "괜찮아요. 과제 전체를 작게 나누는 데 집중해요.",
        completionTitle: "과제 보기 완료",
        completionMessage: "과제를 한 번에 보지 않고 작은 칸으로 볼 준비를 했어요.",
        actionLabel: "과제 확인했어요",
        conceptCards: [
          { title: "전체 보기", body: "해야 할 일이 몇 가지인지 먼저 확인해요." },
          { title: "작게 나누기", body: "바로 할 수 있는 행동으로 쪼개요." },
          { title: "첫 행동", body: "가장 작은 한 가지부터 시작해요." },
        ],
        visualActiveIndex: 0,
      },
      {
        step: 2,
        stageId: "stage-older-2",
        stageRole: "clue_identification",
        templateType: "highlight_clue",
        assetRole: "stage_2",
        kind: "ox",
        prompt: "과제를 시작할 때 조건을 먼저 표시하면 도움이 될까요?",
        body: "긴 글에서 중요한 조건을 찾아 밑줄치면 무엇부터 해야 할지 보이기 쉬워요.",
        oxItems: [
          { statement: "조건을 표시하면 해야 할 일을 더 쉽게 찾을 수 있어요.", correctAnswer: "O" },
          { statement: "긴 과제는 무조건 한 번에 끝내야만 해요.", correctAnswer: "X" },
        ],
        choices: ["O", "X"],
        correctAnswer: "O|X",
        hint: "시작을 쉽게 만드는 방법인지 생각해보세요.",
        correctFeedback: "맞아요. 조건 표시가 첫 행동을 찾는 데 도움이 돼요.",
        wrongFeedback: "한 번에 끝내기보다 시작을 쉽게 만드는 방법을 찾아봐요.",
        completionTitle: "조건 표시 완료",
        completionMessage: "중요한 조건을 먼저 표시하는 이유를 확인했어요.",
        visualActiveIndex: 1,
      },
      {
        step: 3,
        stageId: "stage-older-3",
        stageRole: "action_selection",
        templateType: "decision_card",
        assetRole: "stage_3",
        kind: "quiz",
        ...
        correctAnswer: "문제 1번 읽기",
        hint: "부담이 가장 작은 행동부터 고르면 시작하기 쉬워요.",
        correctFeedback: "좋아요. 첫 행동이 작을수록 시작하기 쉬워요.",
        wrongFeedback: "지금 바로 할 수 있는 아주 작은 행동을 찾아요.",
        completionTitle: "첫 행동 선택 완료",
        completionMessage: "바로 시작할 수 있는 첫 행동을 골랐어요.",
        visualActiveIndex: 0,
      },
      {
        step: 4,
        stageId: "stage-older-4",
        stageRole: "realtime_practice",
        templateType: "realtime_roleplay",
        assetRole: "stage_4_realtime",
        kind: "realtimeTeachBack",
        prompt: "오늘 과제를 시작하는 상황을 말로 연습해요",
        body: "실제로 책상 앞에 앉았을 때 쓸 수 있는 한 문장을 골라 말해요.",
        hint: "완벽하게 끝내기보다 바로 시작할 수 있는 작은 행동을 말해보세요.",
        correctFeedback: "좋아요. 생활에서 바로 쓸 수 있는 말로 바꾸었어요.",
        wrongFeedback: "조금 더 작고 바로 할 수 있는 행동으로 말해볼까요?",
        completionTitle: "생활 적용 연습 완료",
        completionMessage: "오늘 과제를 시작할 수 있는 첫 말을 준비했어요.",
        actionLabel: "생활 적용 연습 시작하기",
        realtimePracticeSpec: {
          role: "student_applies_first_action",
          firstPrompt: "지금 책상 앞이라면 첫 10분을 어떻게 시작할지 말해볼래요?",
          rubric: ["첫 행동을 하나만 말한다", "10분 안에 할 수 있게 줄인다", "바로 시작하는 문장으로 말한다"],
          timeLimitSeconds: 180,
        },
        visualActiveIndex: 0,
      },
